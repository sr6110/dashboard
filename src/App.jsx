...
function App() {
  ...
  return (
    <div >
      <Header />
      <main className='bg-[#F7F8FA] w-screen h-auto px-10 max-sm:px-3 pb-5'>
        <h1 className='py-5 text-2xl'>Welcome, John Paul</h1>
        <section className='flex gap-4 mb-4 max-sm:flex-col'>
          <div className='w-1/3 bg-white shadow-md rounded max-sm:w-full'>
